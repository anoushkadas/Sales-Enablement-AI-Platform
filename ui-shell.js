...
function buildSidebar(active, onNavigate, userEmail, onSignOut) {
  const dealCount = window.APP_DATA.DEALS.length;
  const items = [
    { id: "home", label: "Home", icon: "home" },
    { id: "deals", label: "Active deals", icon: "briefcase", count: dealCount },
    { id: "roadmap", label: "Learning roadmap", icon: "map" },
    { id: "history", label: "History & lookups", icon: "clock" },
    { id: "analytics", label: "My analytics", icon: "chart-bar" },
